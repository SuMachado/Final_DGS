 ...
 */
    ...
    private void addUsers() {
        ...
        try {
            userRepository.add(new User("adm", Role.ADMINISTRATOR, new Email("admin@upskill.pt"), new Password("admin")));
            userRepository.add(new User("nur", Role.NURSE, new Email("nurse@upskill.pt"), new Password("nurse")));
            userRepository.add(new User("rec", Role.RECEPTIONIST, new Email("receptionist@upskill.pt"), new Password("receptionist")));
            userRepository.add(new User("usr", Role.SNSUSER, new Email("snsuser@upskill.pt"), new Password("snsuser")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void addMenus() {
        ...
        //menu.addPermission(Role.ADMINISTRATOR);
        menu = new Menu(menuLogin, 2, "Register Employee", new CreateEmployeeUI());
        menu.addPermission(Role.ADMINISTRATOR);
        //menu = new Menu(menuLogin, 3, "Register Vaccine Technology", new RegisterVaccineTechUI());
        //menu.addPermission(Role.ADMINISTRATOR);
        //menu = new Menu(menuLogin, 4, "Register Vaccine Type", new RegisterVaccineTypeUI());
        //menu.addPermission(Role.ADMINISTRATOR);
        //menu = new Menu(menuLogin, 5, "Register Brand", new RegisterBrandUI());
        //menu.addPermission(Role.ADMINISTRATOR);
        menu = new Menu(menuLogin, 6, "Register Vaccine", new RegisterVaccineUI());
        menu.addPermission(Role.ADMINISTRATOR);
        menu = new Menu(menuLogin, 7, "Register SNS User", new SnsUserRegistrationUI());
        menu.addPermission(Role.ADMINISTRATOR);
  //      menu = new Menu(menuLogin, 7, "Register Facility", new FacilityUI());
 /*       menu.addPermission(Role.ADMINISTRATOR);
        menu = new Menu(menuLogin, 1, "Register User", new CreateUserUI());
        menu.addPermission(Role.ADMINISTRATOR);
        menu = new Menu(menuLogin, 2, "Register Employee", new CreateEmployeeUI());
        ...
        menu = new Menu(menuLogin, 7, "Register Facility", new FacilityUI());*/
        menu.addPermission(Role.ADMINISTRATOR);
    //    menu = new Menu(menuLogin, 8, "Deactivate/Activate Facility", new DeactivateFacilityUI());
        menu.addPermission(Role.ADMINISTRATOR);
       ...
       // menu.addPermission(Role.ADMINISTRATOR);
        ...
        //menu.addPermission(Role.ADMINISTRATOR);
        //menu = new Menu(menuLogin, 17, "List Employees", new ListEmployees());
        //menu.addPermission(Role.ADMINISTRATOR);
       // menu = new Menu(menuLogin, 18, "List of SNS Users", new ListSnsUsers());
        //menu.addPermission(Role.ADMINISTRATOR);

        //Receptionist
        menu = new Menu(menuLogin, 1, "Register SNS User", new SnsUserRegistrationUI());
        menu.addPermission(Role.RECEPTIONIST);
        menu = new Menu(menuLogin, 2, "Schedule Vaccination", new ScheduleVaccinationUI());
        menu.addPermission(Role.RECEPTIONIST);
